...
import io.manasobi.core.db.aop.CreateStatementInterceptor;
import io.manasobi.core.db.aop.StatementExecutionInfo;
import io.manasobi.core.db.monitor.SqlTaskPool;
...
@Setter
@Getter
public class DBCP2DataSource extends BasicDataSource {
