...
public class DataSourceFactory {
    ...
    public static DBCP2DataSource create(String dataSourceId, BaseContextConfig.DataSourceConfig dataSourceConfig) throws Exception {
    ...
    public static DBCP2DataSource create(BaseContextConfig.DataSourceConfig dataSourceConfig) throws Exception {
