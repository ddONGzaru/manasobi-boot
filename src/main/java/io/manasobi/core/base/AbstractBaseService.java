...
import io.manasobi.core.base.model.BaseCrudModel;
...
public abstract class AbstractBaseService<T, ID extends Serializable> extends BaseFilterService<T> {

    protected BaseJPAQueryDSLRepo<T, ID> repository;

    public AbstractBaseService() {}

    public AbstractBaseService(BaseJPAQueryDSLRepo<T, ID> repository) {
    ...
    public <S extends T> S save(S var) {
        ...
        if (var instanceof BaseCrudModel) {
            BaseCrudModel crudModel = (BaseCrudModel) var;
