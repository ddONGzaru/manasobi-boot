...
public class AX5File implements Comparable {
    ...
    public String preview() {
        return "/api/v1/mng/equip/corner_manage/preview?id=" + getId();
    }

    @JsonProperty("thumbnail")
    public String thumbnail() {
        return "/api/v1/mng/equip/corner_manage/thumbnail?id=" + getId();
    }

    @JsonProperty("download")
    public String download() {
        return "/api/v1/mng/equip/corner_manage/download?id=" + getId();
    }
