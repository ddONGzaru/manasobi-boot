package io.manasobi.controller.view.mng.equip.sh02001270;
...
@Controller
public class Sh02001270ViewRouter extends BaseController {

    @GetMapping("/mng/equip/sh02001270")
