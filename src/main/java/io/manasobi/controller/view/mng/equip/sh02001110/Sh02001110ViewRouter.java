package io.manasobi.controller.view.mng.equip.sh02001110;
...
@Controller
public class Sh02001110ViewRouter extends BaseController {

    @GetMapping("/mng/equip/sh02001110")
