package io.manasobi.controller.view.mng.equip.sh02001130;
...
@Controller
public class Sh02001130ViewRouter extends BaseController {

    @GetMapping("/mng/equip/sh02001130")
