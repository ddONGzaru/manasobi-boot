    ...
    PAGE_SEARCH: function (caller, act, data) {
        axboot.ajax({
            ...
            callback: function (res) {
                ...
                caller.formView01.setSingleData("fundExpenseTerm", '0');
            },
            options: {
                onError: viewError
            }
...
fnObj.formView01 = axboot.viewExtend(axboot.formView, {
    ...
    initView: function () {
        ...
        this.setSingleData("fundExpenseTerm", '0');
        ...
        $('#fundExpenseStartDate').change(
            function () {
                ...
                $('#fundExpenseTerm').val(calDateRange($('#fundExpenseStartDate').val(),$('#fundExpenseEndDate').val()));
            }
        )

        $('#fundExpenseEndDate').change(
            function () {
                var sParts = $('#fundExpenseStartDate').val().split('-');
                var sDate = new Date(sParts[0],sParts[1],sParts[2]);
                var eParts = $('#fundExpenseEndDate').val().split('-');
