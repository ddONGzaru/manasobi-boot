    ...
    initView: function () {
        ...
        this.target = axboot.gridBuilder({
            ...
            columns: [
                ...
                {key: 'addCashSendingSeqNo', label: '추가현송일련번호', width: 100, align: 'center', editor: 'text'},
                {key: 'cashSendingDate', label: '현송일', width: 130, align: 'center', editor: 'text'},
                {key: 'billingExpectDate', label: '청구예상일자', width: 130, align: 'center', editor: 'text'},
                {key: 'addCashSendingAmt', label: '추가현송액', width: 130, align: 'right', editor: 'text'},
                {key: 'mngOffice', label: '관리사무소', width: 150, align: 'center', editor: 'text'},
                {key: 'closeGubun', label: '마감구분', width: 70, align: 'center', editor: 'text'},
                {key: 'cashSendingStndDate', label: '현송기준일', width: 130, align: 'center', editor: 'text'},
                {key: 'addCash50kSendingAmt', label: '추가현송액(5만원권)', width: 130, align: 'right', editor: 'text'}
            ],
            body: {
                onClick: function () {
