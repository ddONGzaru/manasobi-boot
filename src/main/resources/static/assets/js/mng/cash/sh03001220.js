            ...
            columns: [
                ...
                {label: '권종별 수령금액', align: 'center',
                    columns: [
                        ...
                        {key: 'cashTypeCode1RecvAmt', label: '권종코드1 수령금액', width: 130, align: 'right', formatter: "money"},
                        {key: 'cashTypeCode2', label: '권종코드2', width: 90, align: 'center',
                            formatter: function formatter() {
                                return parent.COMMON_CODE["AMT_CODE"].map[this.value];
                            }
                        },
                        {key: 'cashTypeCode2RecvAmt', label: '권종코드2 수령금액', width: 130, align: 'right', formatter: "money"},
                        {key: 'cashTypeCode3', label: '권종코드3', width: 90, align: 'center',
                            formatter: function formatter() {
                                return parent.COMMON_CODE["AMT_CODE"].map[this.value];
                            }
                        },
                        {key: 'cashTypeCode3RecvAmt', label: '권종코드3 수령금액', width: 130, align: 'right', formatter: "money"},
                        {key: 'cashTypeCode4', label: '권종코드4', width: 90, align: 'center',
                            formatter: function formatter() {
                                return parent.COMMON_CODE["AMT_CODE"].map[this.value];
                            }
                        },
                        {key: 'cashTypeCode4RecvAmt', label: '권종코드4 수령금액', width: 130, align: 'right', formatter: "money"},
                        {key: 'cashTypeCode5', label: '권종코드5', width: 90, align: 'center',
                            formatter: function formatter() {
                                return parent.COMMON_CODE["AMT_CODE"].map[this.value];
                            }
                        },
                        {key: 'cashTypeCode5RecvAmt', label: '권종코드5 수령금액', width: 130, align: 'right', formatter: "money"}
                    ]
                },
                {label: '카드수령매수', align: 'center',
                    columns: [
                        ...
                        {key: 's20pinkGCardRecvCount', label: 'S20핑크(일반)', width: 90, align: 'center', formatter: "money"},
                        {key: 's20pinkTCardRecvCount', label: 'S20핑크(후불교통)', width: 90, align: 'center', formatter: "money"},
                        {key: 'loveCardRecvCount', label: 'LOVE카드', width: 90, align: 'center', formatter: "money"},
                        {key: 'hipointCardRecvCount', label: 'HIPOINT카드', width: 90, align: 'center', formatter: "money"},
