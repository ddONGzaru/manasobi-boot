...
var ACTIONS = axboot.actionExtend(fnObj, {
    PAGE_SEARCH: function (caller, act, data) {
        axboot.ajax({
            type: "GET",
            //url: ["samples", "parent"],
            url: "/api/v1//mng/equip/sh02001100",
    ...
    EXCEL_DOWNLOAD: function (caller, act, data) {
        ...
        console.log(params);
        window.location = CONTEXT_PATH + "/api/v1//mng/equip/sh02001100/download?" + params;
        return false;
    },
    ...
    initView: function () {
        ...
        this.target = axboot.gridBuilder({
            ...
            columns: [
                ...
                {key: 'changeChasu', label: '변경차수', width: 80, align: 'center'},
                {key: 'stextGubun', label: '전문구분', width: 80, align: 'center'},
                {key: 'workGubun', label: '작업구분', width: 80, align: 'center'},
                {key: 'noticeDatetime', label: '통보일', width: 130, align: 'center'},
                {key: 'taskApplyDate', label: '업무적용일', width: 130, align: 'center'},
                {key: 'workDate', label: '작업일', width: 130, align: 'center'},
                {key: 'installTerminalCount', label: '설치기기대수', width: 100, align: 'right'},
                {key: 'installFacCount', label: '설치시설물대수', width: 100, align: 'right'},
                {key: 'branchName', label: '지점명', width: 100, align: 'left'},
                {key: 'cornerName', label: '코너명', width: 100, align: 'left'},
                {key: 'bizManagerName', label: '지점담당자명', width: 100, align: 'center'},
                {key: 'managerTelno', label: '담당자연락처', width: 100, align: 'center'},
                {key: 'workContent', label: '작업내용', width: 100, align: 'center'}
            ],
            body: {
                onClick: function () {
