...
var ACTIONS = axboot.actionExtend(fnObj, {
    PAGE_SEARCH: function (caller, act, data) {
        axboot.ajax({
            type: "GET",
            //url: ["samples", "parent"],
            url: "/api/v1//mng/equip/sh02001280",
    ...
    EXCEL_DOWNLOAD: function (caller, act, data) {
        ...
        window.location = CONTEXT_PATH + "/api/v1//mng/equip/sh02001280/download?" + params;
        return false;
    },
    ...
    initView: function () {
        ...
        this.target = axboot.gridBuilder({
            ...
            columns: [
                ...
                {key: 'chasu', label: '차수', width: 60, align: 'center'},
                ...
                {key: 'workDate', label: '작업일시', width: 150, align: 'center'},
                {key: 'workContent', label: '작업내용', width: 100, align: 'left'}
            ],
            body: {
                onClick: function () {
        ...
        axboot.buttonClick(this, "data-grid-view-01-btn", {
            ...
            "excel": function () {
                _this.excel("기타작업정보-"+getFormattedDate(new Date())+".xls");
            }
        });
    },
