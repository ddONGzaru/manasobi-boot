...
var ACTIONS = axboot.actionExtend(fnObj, {
    ...
    EXCEL_DOWNLOAD: function (caller, act, data) {
        ...
        window.location = CONTEXT_PATH + "/api/v1//mng/etc/sh04001180/download?" + params;
        return false;
    },
    ...
    initView: function () {
        ...
        this.target = axboot.gridBuilder({
            ...
            columns: [
                ...
                {key: 'crtNo', label: 'CRT번호', width: 110, align: 'center', editor: 'text'}
            ],
            body: {
                onClick: function () {
        ...
        axboot.buttonClick(this, "data-grid-view-01-btn", {
            ...
            "excel": function () {
                _this.excel("CRT번호등록/변경-"+getFormattedDate(new Date())+".xls");
            }
        });
    },
    getData: function (_type) {
        ...
        if (_type == "modified" || _type == "deleted") {
            list = ax5.util.filter(_list, function () {
                return this.txId && this.branchCode && this.cornerCode;
            });
        } else {
            list = _list;
        }
