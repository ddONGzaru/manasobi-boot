    ...
    initView: function () {
        ...
        this.target = axboot.gridBuilder({
            ...
            columns: [
                ...
                {key: 'basicServiceFee', label: '기본용역료', width: 130, align: 'right', editor: 'text', formatter: 'money'},
                {key: 'terminalAddServiceFee', label: '단말추가용역료', width: 130, align: 'right', editor: 'text', formatter: 'money'},
                {key: 'timeAddServiceFee', label: '시간추가용역료', width: 130, align: 'right', editor: 'text', formatter: 'money'},
                {key: 'checkAddServiceFee', label: '수표추가용역료', width: 130, align: 'right', editor: 'text', formatter: 'money'},
                ...
                {key: 'totalGiveSeviceFee', label: '최종지급용역료', width: 130, align: 'right', editor: 'text', formatter: 'money'},
