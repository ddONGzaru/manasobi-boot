...
var ACTIONS = axboot.actionExtend(fnObj, {
    PAGE_SEARCH: function (caller, act, data) {
        axboot.ajax({
            type: "GET",
            url: "/api/v1//mng/error/sh01001140",
    ...
    EXCEL_DOWNLOAD: function (caller, act, data) {
        ...
        console.log(params);
        window.location = CONTEXT_PATH + "/api/v1//mng/error/sh01001140/download?" + params;
        return false;
    },
    ...
    initView: function () {
        ...
        this.target = axboot.gridBuilder({
            ...
            columns: [
                ...
                {key: 'cornerArrivalDatetime', label: '코너도착일시', width: 130, align: 'center', editor: 'text'},
                {key: 'arrivalCorpCode', label: '코너업체코드', width: 100, align: 'left', editor: 'text'},
