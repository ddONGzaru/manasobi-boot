        ...
        axboot
            .call({
                ...
                callback: function (res) {
                    ...
                    res.cash10kEmptyStatus =  parent.COMMON_CODE["CASH_PART_STATUS"].map[res.cash10kEmptyStatus];
                    res.cash50kEmptyStatus =  parent.COMMON_CODE["CASH_PART_STATUS_50K_WON"].map[res.cash50kEmptyStatus];
                    ...
                    // 기기정보
                    fnObj.formView01.setFormData("orgName",parent.COMMON_CODE["ORG_CODE"].map['01']);
                    fnObj.formView01.setFormData("placeGubun",parent.COMMON_CODE["PLACE_GUBUN"].map[data.placeGubun]);
                    fnObj.formView01.setFormData("jisaName",parent.COMMON_CODE["JISA_CODE"].map[data.jisaCode]);
                    fnObj.formView01.setFormData("runtime",data.runtime);
                    fnObj.formView01.setFormData("mngChannel",data.mngChannel);
                    fnObj.formView01.setFormData("prodSerialNo",data.prodSerialNo);
                    fnObj.formView01.setFormData("branchName",data.branchName);
                    fnObj.formView01.setFormData("boothCorp",parent.COMMON_CODE["BOOTH_CORP"].map[data.boothCorp]);
                    fnObj.formView01.setFormData("cornerName",data.cornerName);
                    fnObj.formView01.setFormData("boothType",parent.COMMON_CODE["BOOTH_TYPE"].map[data.boothType]);
                    fnObj.formView01.setFormData("terminalNo",data.terminalNo);
                    fnObj.formView01.setFormData("internetClassify",data.internetClassify);
                    fnObj.formView01.setFormData("modelName",parent.COMMON_CODE["MODEL_CODE"].map[data.terminalCorpCode + data.modelCode]);
                    fnObj.formView01.setFormData("commOffice",data.internetClassify);
                    fnObj.formView01.setFormData("terminalCorpName",parent.COMMON_CODE["TERMINAL_CORP_CODE"].map[data.terminalCorpCode]);
                    fnObj.formView01.setFormData("intercomNo",data.internetClassify);
                    fnObj.formView01.setFormData("terminalLocation",data.terminalLocation);
                    fnObj.formView01.setFormData("intercomNo",' - ');
                },
                options: {
                    onError: viewError
                }
    ...
    initView: function () {
        ...
        this.target = axboot.gridBuilder({
            ...
            columns: [
                ...
                {key: 'totalClassifyCode', label: '장애메세지', width: 100, align: 'left', formatter: function formatter() {
