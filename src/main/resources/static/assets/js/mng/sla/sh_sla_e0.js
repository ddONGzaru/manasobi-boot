...
fnObj.gridView01 = axboot.viewExtend(axboot.gridView, {
    ...
    initView: function () {
        ...
        this.target = axboot.gridBuilder({
            ...
            columns: [
                {key: 'stndDate', label: '기준월', width: 100, align: 'left', editor: 'text'},
                ...
                {key: 'operStartTime', label: '운영시작시간', width: 100, align: 'left', editor: 'text'},
                {key: 'operEndTime', label: '운영종료시간', width: 100, align: 'left', editor: 'text'},
                {key: 'modelName', label: '기종', width: 100, align: 'left', editor: 'text'},
                {key: 'totalOperTime', label: '총운영시간', width: 100, align: 'left', editor: 'text'},
                {key: 'realOperTime', label: '실제운영시간', width: 100, align: 'left', editor: 'text'},
                {key: 'noneOperTime', label: '미운영시간', width: 100, align: 'left', editor: 'text'}
            ],
            body: {
                onClick: function () {
    ...
    getData: function (_type) {
        ...
        if (_type == "modified" || _type == "deleted") {
            list = ax5.util.filter(_list, function () {
                return this.stndDate && this.txId;
            });
        } else {
            list = _list;
        }
