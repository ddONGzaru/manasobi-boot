    ...
    initView: function () {
        ...
        this.target = axboot.gridBuilder({
            ...
            columns: [
                ...
                {key: 'regDatetime', label: '등록일자', width: 100, align: 'left', editor: 'text'},
                {key: 'equals', label: '일치여부', width: 100, align: 'left', editor: 'text'},
                {key: 'etc', label: '비고', width: 100, align: 'left', editor: 'text'}
            ],
            body: {
                onClick: function () {
    ...
    getData: function (_type) {
        ...
        if (_type == "modified" || _type == "deleted") {
            list = ax5.util.filter(_list, function () {
                return this.corpCode && this.regDatetime;
            });
        } else {
            list = _list;
        }
