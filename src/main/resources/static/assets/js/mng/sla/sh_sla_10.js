    ...
    initView: function () {
        ...
        this.target = axboot.gridBuilder({
            ...
            columns: [
                ...
                {key: 'securityCorp', label: '경비사', width: 100, align: 'left', editor: 'text'},
                {key: 'calleeReqReason', label: '출동사유', width: 100, align: 'left', editor: 'text'},
                ...
                {key: 'report', label: '처리내용', width: 100, align: 'left', editor: 'text'},
                {key: 'accept', label: '인정유뮤', width: 100, align: 'left', editor: 'text'},
