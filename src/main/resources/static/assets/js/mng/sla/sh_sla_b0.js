    ...
    initView: function () {
        ...
        this.target = axboot.gridBuilder({
            ...
            columns: [
                ...
                {key: 'totalCorp', label: '토탈업체', width: 100, align: 'left', editor: 'text'},
                ...
                {key: 'mngGubun', label: '관리구분', width: 100, align: 'left', editor: 'text'},
                {key: 'operTimeGubun', label: '운영구분', width: 100, align: 'left', editor: 'text'},
                {key: 'terminalCorpName', label: '기기업체', width: 100, align: 'left', editor: 'text'},
                {key: 'modelName', label: '기종', width: 100, align: 'left', editor: 'text'},
                {key: 'atmGubun', label: 'ATM/CD구분', width: 100, align: 'left', editor: 'text'},
                {key: 'overhaulDatetime', label: '점검일시', width: 100, align: 'left', editor: 'text'}
            ],
            body: {
                onClick: function () {
    ...
    getData: function (_type) {
        ...
        if (_type == "modified" || _type == "deleted") {
            list = ax5.util.filter(_list, function () {
                return this.txId && this.overhaulDatetime;
            });
        } else {
            list = _list;
        }
