    ...
    initView: function () {
        ...
        this.target = axboot.gridBuilder({
            ...
            columns: [
                ...
                {key: 'customerWait', label: '고객대기유무', width: 100, align: 'left', editor: 'text'},
                {key: 'evalType', label: '평가구분', width: 100, align: 'left', editor: 'text'},
                {key: 'corpCode', label: '업체', width: 100, align: 'left', editor: 'text'},
                {key: 'calleeType', label: '출동형태', width: 100, align: 'left', editor: 'text'},
                ...
                {key: 'arrivalPlanDatetime', label: '도착예정일시', width: 100, align: 'left', editor: 'text'},
                {key: 'arrivalDatetime', label: '도착일시', width: 100, align: 'left', editor: 'text'},
                {key: 'arrivalType', label: '도착처리방법', width: 100, align: 'left', editor: 'text'},
                {key: 'calleeReqElapsedTime', label: '출동경과시간', width: 100, align: 'left', editor: 'text'},
                {key: 'calleeReqElapsedSeconds', label: '출동경과시간(초)', width: 100, align: 'left', editor: 'text'},
                {key: 'arrivalElapsedTime', label: '도착준수시간', width: 100, align: 'left', editor: 'text'},
                {key: 'arrivalElapsedSeconds', label: '도착준수시간(초)', width: 100, align: 'left', editor: 'text'},
                {key: 'reportDatetime', label: '도착후업체보고예정일시', width: 100, align: 'left', editor: 'text'},
