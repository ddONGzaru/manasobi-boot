    ...
    initView: function () {
        ...
        this.target = axboot.gridBuilder({
            ...
            columns: [
                ...
                {key: 'recoveryDatetime', label: '복구일시', width: 100, align: 'left', editor: 'text'},
                ...
                {key: 'errorContent', label: '쟁애내용', width: 100, align: 'left', editor: 'text'},
    ...
    getData: function (_type) {
        ...
        if (_type == "modified" || _type == "deleted") {
            list = ax5.util.filter(_list, function () {
                return this.txId && this.errorDatetime;
            });
        } else {
            list = _list;
        }
