    ...
    initView: function () {
        ...
        this.target = axboot.gridBuilder({
            ...
            columns: [
                ...
                {key: 'minwonDatetime', label: '민원발생일', width: 100, align: 'left', editor: 'text'},
                ...
                {key: 'regType', label: '등록구분', width: 100, align: 'left', editor: 'text'},
                {key: 'handleType', label: '접수구분', width: 100, align: 'left', editor: 'text'},
                {key: 'minwonType', label: '민원구분', width: 100, align: 'left', editor: 'text'},
                {key: 'content', label: '내용', width: 100, align: 'left', editor: 'text'},
                {key: 'regDatetime', label: '등록일', width: 100, align: 'left', editor: 'text'}
            ],
            body: {
                onClick: function () {
