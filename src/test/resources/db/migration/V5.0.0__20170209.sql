...
CREATE TABLE atms_05001120 (
  ...
  outside_billboard_photo   VARCHAR(100),
  gate_photo                VARCHAR(100),
  floar_photo               VARCHAR(100),
  booth_left_photo          VARCHAR(100),
  booth_right_photo         VARCHAR(100),
  ceiling_photo             VARCHAR(100),
  terminal_top_photo        VARCHAR(100),
  terminal_bottom_photo     VARCHAR(100),
  PRIMARY KEY (branch_code , corner_code, overhaul_date)
);
...
CREATE TABLE atms_05001140 (
  ...
  corner_name               VARCHAR(40),
  photo_url                 VARCHAR(100),
  terminal_front_glass      VARCHAR(100),
  terminal_front            VARCHAR(100),
  terminal_cracks           VARCHAR(100),
  monitor                   VARCHAR(100),
  bnkb_part_entrance_cracks VARCHAR(100),
  card_part_entrance_cracks VARCHAR(100),
  intercom                  VARCHAR(100),
  board_cradle              VARCHAR(100),
  branch_floor              VARCHAR(100),
  inside_wall               VARCHAR(100),
  outside_wall              VARCHAR(100),
  branch_glass              VARCHAR(100),
  ceiling                   VARCHAR(100),
  fluorescent_light         VARCHAR(100),
  sticking_billboard        VARCHAR(100),
  garbagecan                VARCHAR(100),
  cooler_heater             VARCHAR(100),
  branch_periphery          VARCHAR(100),
  PRIMARY KEY (branch_code , corner_code , overhaul_date)
);
