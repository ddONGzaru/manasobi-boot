...
CREATE TABLE atms_01001120 (
  ...
  callee_emp_name           VARCHAR(10),
  callee_emp_telno          VARCHAR(13),
  terminal_error_code_1     VARCHAR(5),
  terminal_error_code_2     VARCHAR(10),
  total_classify_code       VARCHAR(2),
  callee_req_unusl          VARCHAR(200),
  crt_no                    VARCHAR(15),
...
CREATE TABLE atms_01001130 (
  ...
  corp_receipt_emp_name     VARCHAR(10),
  corp_callee_emp_name      VARCHAR(10),
  corp_callee_emp_telno     VARCHAR(13),
  unusl                     VARCHAR(100),
  crt_no                    VARCHAR(15),
  PRIMARY KEY (error_datetime, branch_code, corner_code, terminal_no)
);
...
CREATE TABLE atms_01001150 (
  ...
  handle_fail_reason         VARCHAR(1),
  as_method                  VARCHAR(1),
  handle_datetime            TIMESTAMP NOT NULL,
  handle_emp_name            VARCHAR(10),
  handle_emp_telno           VARCHAR(13),
  handle_content_code        CHAR(1),
  handle_unusl               VARCHAR(200),
  crt_no                     VARCHAR(15),
  PRIMARY KEY (error_datetime, branch_code, corner_code, terminal_no)
);
...
CREATE TABLE atms_01001160 (
  ...
  callee_cancle_reason_code   VARCHAR(1),
  unusl                       VARCHAR(200),
  crt_no                      VARCHAR(15),
  callee_req_reason_code      VARCHAR(1),
  terminal_error_code_1       VARCHAR(5),
  terminal_error_code_2       VARCHAR(10),
  total_classify_code         VARCHAR(2),
  PRIMARY KEY (error_datetime, branch_code, corner_code, terminal_no)
...
CREATE TABLE atms_error_status (
  ...
  tx_id                       CHAR(7),
  error_type                  CHAR(1),
  error_process_status        INTEGER(1),
...
CREATE TABLE atms_error_handle_mng (
  ...
  customer_info             VARCHAR(300),
  handle_content            VARCHAR(300),
  last_modify_datetime      TIMESTAMP,
  last_modify_emp_name      VARCHAR(20),
...
CREATE TABLE atms_01001180 (
  ...
  terminal_error2         CHAR(10),
  handle_datetime         TIMESTAMP,
  handle_emp_name         VARCHAR(20),
  memo_content            VARCHAR(140),
...
CREATE TABLE atms_01001230 (
  ...
  handle_notice_emp_name  VARCHAR(20),
  handle_notice_emp_telno VARCHAR(20),
  handle_req_desc         VARCHAR(200),
  ...
  handle_datetime         TIMESTAMP,
  handle_emp_name         VARCHAR(20),
  handle_emp_telno        VARCHAR(20),
  handle_desc             VARCHAR(200),
...
CREATE TABLE atms_minwon_mng (
  ...
  handle_dept               CHAR(1),
  minwon_content            VARCHAR(300),
  handle_content            VARCHAR(300),
  update_datetime           TIMESTAMP, -- 변경일시
  last_modify_emp_name      VARCHAR(20), -- 민원작성자
