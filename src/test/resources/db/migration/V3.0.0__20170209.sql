...
CREATE TABLE atms_03001220 (
  ...
  charge_emp_name            VARCHAR(20),
  charge_emp_regno           CHAR(13),
  charge_emp_photo_url       VARCHAR(100),
...
CREATE TABLE atms_jisa_sije_close (
  ...
  close_date                  TIMESTAMP NOT NULL,
  jisa_code                   VARCHAR(2) NOT NULL,
  prev_day_reserve_sije       VARCHAR(15),
  this_day_cash_deposit_amt   VARCHAR(15),
  jisa_to_shinhan_send_amt    VARCHAR(15),
  close_amt                   VARCHAR(15),
  un_check_amt                VARCHAR(15),
  sije_mistake_amt            VARCHAR(15),
  cash_sending_amt            VARCHAR(15),
  add_cash_sending_amt        VARCHAR(15),
  jisa_safe_amt               VARCHAR(15),
